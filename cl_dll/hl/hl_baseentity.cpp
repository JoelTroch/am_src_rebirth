...
// UTIL_* Stubs
//SP FIXs
void UTIL_Sparks(class Vector const &) { }
void UTIL_ScreenFade(class CBaseEntity *,class Vector const &,float,float,int,int) { }
...
CGrenade * CGrenade:: ShootTimedCz( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
CGrenade * CGrenade:: ShootTimedPlayer( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, CBasePlayer *pPlayer ){ return 0; }
CGrenade * CGrenade:: ShootC4( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
CGrenade * CGrenade:: ShootTimedCombine( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }

CGrenade * CGrenade:: ShootTimedCluster( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
CGrenade * CGrenade:: ShootFragment( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
CGrenade * CGrenade:: ShootFlashbang( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
//CGrenade * CGrenade:: ShootSmoke( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
CGrenade * CGrenade:: ShootTimedSmoke( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
CGrenade * CGrenade:: FlashShootTimed( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
CGrenade * CGrenade:: ShootSfera( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ){ return 0; }
...
void CBasePlayer::RestoreSpeedVol(void) { }//sys

void CSoundEnt::InsertSound ( int iType, const Vector &vecOrigin, int iVolume, float flDuration ) {}
void RadiusDamage( Vector vecSrc, entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, float flRadius, int iClassIgnore, int bitsDamageType ){}

void CBaseEntity::SetNextThink(float,int){}