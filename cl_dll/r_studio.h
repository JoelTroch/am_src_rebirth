...
public:
	...
	virtual void Chrome (int *pchrome, int bone, vec3_t normal);
	virtual void Lighting (float *lv, int bone, int flags, vec3_t normal);
public:
	// Client clock
	double			m_clTime;				
	// Old Client clock
