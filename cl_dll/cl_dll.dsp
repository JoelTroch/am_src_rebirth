...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib winmm.lib ../utils/vgui/lib/win32_vc6/vgui.lib wsock32.lib opengl32.lib ../common/cg/cg.lib ../common/cg/cgGL.lib glu32.lib /nologo /subsystem:windows /dll /machine:I386 /out:".\Release\client.dll"
...
"c:\Archivos de programa\Valve\rebirth\cl_dlls\client.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\client.dll "c:\Archivos de programa\Valve\rebirth\cl_dlls\client.dll"
...
SOURCE=.\SysOp_Readme.txt
# End Source File
# End Group
# Begin Source File

SOURCE=..\avikit\src\avikit.cpp
...
SOURCE=..\avikit\include\avikit.h
# End Source File
# Begin Source File
