...
//	sprintf(sz, "sprites/%s.txt", pWeapon->szName);//here? //sprites/weaponsprites/ ?
	sprintf(sz, "scripts/%s.txt", pWeapon->szName);//here? //sprites/weaponsprites/ ?
	...
	if (p)
	{
		sprintf(sz, "sprites/%s.spr", p->szSprite);//here? //sprites/weaponsprites/ ?
...
int CHudAmmo::DrawWList(float flTime)
{
	...
	y = 10; //!!!
/*
	x = CVAR_GET_FLOAT( "cl_list_x" ); //!!!
	y = CVAR_GET_FLOAT( "cl_list_y" ); //!!!	
*/
...
/*
	a = CVAR_GET_FLOAT( "cl_bucket_x" );
	x = CVAR_GET_FLOAT( "cl_bucket_y" );
*/
