...
private:
	...
	CCinePanel      *m_pCinePanel;
		CRicardoPanel      *m_pRicardoPanel;
public:
		CCommandMenu *m_pCurrentCommandMenu;

	/////////
		void CreateRicardo( void );
	void ShowRicardo( void );
	void HideRicardo( void );
	///////////
	void CreateCine( void );
	void ShowCine( void );
	void HideCine( void );
/////////
...
///////////////
class CCinePanel : public Label
{
private:
   BitmapTGA   *Cine;
public:
   CCinePanel(int x,int y,int wide,int tall);
   void Update();
...
///////////////
class CRicardoPanel : public Label
{
private:
   BitmapTGA   *Ricardo;
public:
   CRicardoPanel(int x,int y,int wide,int tall);
   void Update();
