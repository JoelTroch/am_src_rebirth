...
{
	PRECACHE_MODEL("models/weapons/egon/w_egon.mdl");
	PRECACHE_MODEL("models/weapons/egon/v_egon.mdl");
	PRECACHE_MODEL("models/weapons/egon/p_egon.mdl");
	...
	m_usEgonFire = PRECACHE_EVENT ( 1, "scripts/events/egon_fire.sc" );
	m_usEgonStop = PRECACHE_EVENT ( 1, "scripts/events/egon_stop.sc" );
}
...
BOOL CEgon::Deploy( void )
{
	...
	return DefaultDeploy( "models/weapons/egon/v_egon.mdl", "models/weapons/egon/p_egon.mdl", EGON_DRAW, "egon" );
}
...
int CEgon::AddToPlayer( CBasePlayer *pPlayer )
{
	...
	{
		ClientPrint(m_pPlayer->pev, HUD_PRINTCENTER, "#Pickup_Egon"); //digamos al cliente

		m_pPlayer->SetSuitUpdate("!HEV_EGON", FALSE, SUIT_NEXT_IN_5SEC);
