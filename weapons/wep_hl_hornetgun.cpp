...
{
	PRECACHE_MODEL("models/weapons/hgun/v_hgun.mdl");
	PRECACHE_MODEL("models/weapons/hgun/w_hgun.mdl");
	PRECACHE_MODEL("models/weapons/hgun/p_hgun.mdl");

	m_usHornetFire = PRECACHE_EVENT ( 1, "scripts/events/firehornet.sc" );
...
#endif
		ClientPrint(m_pPlayer->pev, HUD_PRINTCENTER, "#Pickup_Hgun"); //digamos al cliente
...
int CHgun::GetItemInfo(ItemInfo *p)
{
	...
	p->iSlot = 3;
	p->iPosition = 3;
	p->iId = m_iId = WEAPON_HL_HORNETGUN;
...
BOOL CHgun::Deploy( )
{
	return DefaultDeploy( "models/weapons/hgun/v_hgun.mdl", "models/weapons/hgun/p_hgun.mdl", HGUN_UP, "hive" );
}
