...
void CCrossbowBolt::Spawn( )
{
	...
	SET_MODEL(ENT(pev), "models/weapons/crossbow/crossbow_bolt.mdl");
...
{
	PRECACHE_MODEL ("models/weapons/crossbow/crossbow_bolt.mdl");
...
int CCrossbow::AddToPlayer( CBasePlayer *pPlayer )
{
	...
	{
		ClientPrint(m_pPlayer->pev, HUD_PRINTCENTER, "#Pickup_Crossbow"); //digamos al cliente

		m_pPlayer->SetSuitUpdate("!HEV_CROSSBOW", FALSE, SUIT_NEXT_IN_5SEC);
...
{
	PRECACHE_MODEL("models/weapons/crossbow/w_crossbow.mdl");
	PRECACHE_MODEL("models/weapons/crossbow/v_crossbow.mdl");
	PRECACHE_MODEL("models/weapons/crossbow/p_crossbow.mdl");
...
{
	if (m_iClip)
		return DefaultDeploy( "models/weapons/crossbow/v_crossbow.mdl", "models/weapons/crossbow/p_crossbow.mdl", CROSSBOW_DRAW1, "bow" );
	return DefaultDeploy( "models/weapons/crossbow/v_crossbow.mdl", "models/weapons/crossbow/p_crossbow.mdl", CROSSBOW_DRAW2, "bow" );
}
...
class CCrossbowAmmo : public CBasePlayerAmmo
{
	...
	{ 
		Precache( );
		SET_MODEL(ENT(pev), "models/weapons/crossbow/w_crossbow_clip.mdl");
		CBasePlayerAmmo::Spawn( );
	}
	void Precache( void )
	{
		PRECACHE_MODEL ("models/weapons/crossbow/w_crossbow_clip.mdl");
