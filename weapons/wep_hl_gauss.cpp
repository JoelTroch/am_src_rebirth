...
{
	PRECACHE_MODEL("models/weapons/gauss/w_gauss.mdl");
	PRECACHE_MODEL("models/weapons/gauss/v_gauss.mdl");
	PRECACHE_MODEL("models/weapons/gauss/p_gauss.mdl");
	...
	m_usGaussFire = PRECACHE_EVENT( 1, "scripts/events/gauss.sc" );
	m_usGaussSpin = PRECACHE_EVENT( 1, "scripts/events/gaussspin.sc" );
}
...
int CGauss::AddToPlayer( CBasePlayer *pPlayer )
{
	...
	{
		ClientPrint(m_pPlayer->pev, HUD_PRINTCENTER, "#Pickup_Gauss"); //digamos al cliente

		m_pPlayer->SetSuitUpdate("!HEV_GAUSS", FALSE, SUIT_NEXT_IN_5SEC);
...
BOOL CGauss::Deploy( )
{
	...
	return DefaultDeploy( "models/weapons/gauss/v_gauss.mdl", "models/weapons/gauss/p_gauss.mdl", GAUSS_DRAW, "gauss" );
}
