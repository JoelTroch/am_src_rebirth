...
void CRpgRocket :: Spawn( void )
{
	...
	SET_MODEL(ENT(pev), "models/weapons/rpg/rpgrocket.mdl");
...
{
	PRECACHE_MODEL("models/weapons/rpg/rpgrocket.mdl");
...
{
	PRECACHE_MODEL("models/weapons/rpg/w_rpg.mdl");
	PRECACHE_MODEL("models/weapons/rpg/v_rpg.mdl");
	PRECACHE_MODEL("models/weapons/rpg/p_rpg.mdl");
	...
	m_usRpg = PRECACHE_EVENT ( 1, "scripts/events/rpg.sc" );
}
...
int CRpg::AddToPlayer( CBasePlayer *pPlayer )
{
	...
	{
		ClientPrint(m_pPlayer->pev, HUD_PRINTCENTER, "#Pickup_RPG"); //digamos al cliente

		m_pPlayer->SetSuitUpdate("!HEV_RPG", FALSE, SUIT_NEXT_IN_5SEC);
...
BOOL CRpg::Deploy( )
{
	...
	if ( m_iClip == 0 )
	{
		return DefaultDeploy( "models/weapons/rpg/v_rpg.mdl", "models/weapons/rpg/p_rpg.mdl", RPG_DRAW_UL, "rpg" );
	}

	return DefaultDeploy( "models/weapons/rpg/v_rpg.mdl", "models/weapons/rpg/p_rpg.mdl", RPG_DRAW1, "rpg" );
}
