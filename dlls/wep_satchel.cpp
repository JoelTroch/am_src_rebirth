...
LINK_ENTITY_TO_CLASS( weapon_c4, CSatchel );
...
BOOL CSatchel::Deploy( )
{
	...
	if ( m_chargeReady )
		return DefaultDeploy( "models/weapons/semtex/v_semtex_radio.mdl", "models/p_satchel_radio.mdl", SATCHEL_RADIO_DRAW, "hive" );
	else
		return DefaultDeploy( "models/weapons/semtex/v_semtex.mdl", "models/p_satchel.mdl", SATCHEL_DRAW, "trip" );
