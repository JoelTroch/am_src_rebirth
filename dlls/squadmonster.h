...
// HUMAN TERRORIST
#define bits_SLOT_TERRORIST_ENGAGE1	( 1 << 0 )
#define bits_SLOT_TERRORIST_ENGAGE2	( 1 << 1 )
#define bits_SLOTS_TERRORIST_ENGAGE	( bits_SLOT_TERRORIST_ENGAGE1 | bits_SLOT_TERRORIST_ENGAGE2 )

#define bits_SLOT_TERRORIST_GRENADE1	( 1 << 2 ) 
#define bits_SLOT_TERRORIST_GRENADE2	( 1 << 3 ) 
#define bits_SLOTS_TERRORIST_GRENADE	( bits_SLOT_TERRORIST_GRENADE1 | bits_SLOT_TERRORIST_GRENADE2 )
...
// HUMAN GRUNT SLOTS
#define bits_SLOT_COMBINE_ENGAGE1	( 1 << 0 )
#define bits_SLOT_COMBINE_ENGAGE2	( 1 << 1 )
#define bits_SLOTS_COMBINE_ENGAGE	( bits_SLOT_COMBINE_ENGAGE1 | bits_SLOT_COMBINE_ENGAGE2 )

#define bits_SLOT_COMBINE_GRENADE1	( 1 << 2 ) 
#define bits_SLOT_COMBINE_GRENADE2	( 1 << 3 ) 
#define bits_SLOTS_COMBINE_GRENADE	( bits_SLOT_COMBINE_GRENADE1 | bits_SLOT_COMBINE_GRENADE2 )

// global slots
#define bits_SLOT_SQUAD_SPLIT		( 1 << 10 )// squad members don't all have the same enemy

#define NUM_SLOTS			32//16 update this every time you add/remove a slot.
