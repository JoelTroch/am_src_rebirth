//there is a small crash using HEVSCI in this file...
#if _CODE_CRASH_TEST
...
#define	 BARNEY_AE_DROPAMMO		( 14 )

//shut up!
#define BODY_GROUP					0
#define GUN_GROUP					1
#define ARMS_GROUP					2//new: to support LOD in arms
#define HEAD_GROUP					3	
...
#define BARNEY_BODY_LOD0			0
#define BARNEY_BODY_LOD1			1
#define BARNEY_BODY_LOD2			2
#define BARNEY_BODY_LOD3			3
/*
#define BARNEY_GUN_LOD0				0
#define BARNEY_GUN_LOD1				1
#define BARNEY_GUN_LOD2				2
#define BARNEY_GUN_LOD3				3
*/
#define BARNEY_ARMS_LOD0			0
#define BARNEY_ARMS_LOD1			1
#define BARNEY_ARMS_LOD2			2
#define BARNEY_ARMS_LOD3			3

#define BARNEY_HEAD_LOD0			0
#define BARNEY_HEAD_LOD1			1
#define BARNEY_HEAD_LOD2			2
#define BARNEY_HEAD_LOD3			3
...
void CBarney :: BarneyFirePistol ( void )
{
	...
	if (pev->frags)
	{
		FireBullets(1, vecShootOrigin, vecShootDir, VECTOR_CONE_2DEGREES, 1024, BULLET_PLAYER_DEAGLE);//357
		if (RANDOM_LONG(0, 1))
...
void CBarney :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	case BARNEY_AE_DRAW:
		...
		{
			SetBodygroup( GUN_GROUP, 1 );//gun deployed
		}
	...
	case BARNEY_AE_HOLSTER:
		...
		{
			SetBodygroup( GUN_GROUP, 0 );//gun none
		}

		m_fGunDrawn = FALSE;
		break;

	case BARNEY_AE_DROPAMMO:
...
void CBarney::Killed( entvars_t *pevAttacker, int iGib )
{
	...
	{// drop the gun! (only if the monster has a gun -holstered or picked up-)
		Vector vecGunPos;
		Vector vecGunAngles;
		...
		SetBodygroup( GUN_GROUP, BARNEY_BODY_GUNGONE );//gun none
...
{/*
	if ( IsAlive() )
	{
//		ALERT( at_console, "LOD -level 3-\n" );
			
		SetBodygroup( BODY_GROUP, BARNEY_BODY_LOD3 );
		SetBodygroup( ARMS_GROUP, BARNEY_ARMS_LOD3 );
		SetBodygroup( HEAD_GROUP, BARNEY_HEAD_LOD3 );
		...
		{	
			...
			if ( flDist >= 512)
			{
//				ALERT( at_console, "LOD -level 2-\n" );

				SetBodygroup( BODY_GROUP, BARNEY_BODY_LOD2 );
				SetBodygroup( ARMS_GROUP, BARNEY_ARMS_LOD2 );
				SetBodygroup( HEAD_GROUP, BARNEY_HEAD_LOD2 );
			}
		}
...
//				ALERT( at_console, "LOD -level 1-\n" );
				...
				SetBodygroup( BODY_GROUP, BARNEY_BODY_LOD1 );
				SetBodygroup( ARMS_GROUP, BARNEY_ARMS_LOD1 );
				SetBodygroup( HEAD_GROUP, BARNEY_HEAD_LOD1 );
			}
		}

		CBaseEntity *pEntidadLODcheck0 = NULL;
		
		while ((pEntidadLODcheck0 = UTIL_FindEntityByClassname(pEntidadLODcheck0, "player")) != NULL) 
		{	
			float flDist = (pEntidadLODcheck0->Center() - pev->origin).Length();

			if ( flDist >= 128)
			{
//				ALERT( at_console, "LOD -level 0-\n" );

				SetBodygroup( BODY_GROUP, BARNEY_BODY_LOD0 );
				SetBodygroup( ARMS_GROUP, BARNEY_ARMS_LOD0 );
				SetBodygroup( HEAD_GROUP, BARNEY_HEAD_LOD0 );
			}
		}
	}//is alive check	
	*/
