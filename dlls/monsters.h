...
#define SF_MONSTER_DONT_REACT			2048//Don't get frustrated
...
public:
	...
	static	void HgruntArmGib( entvars_t *pevVictim );//SP: para el brazo, declaracion
	static	void RobotGibs( entvars_t *pevVictim, int cGibs, int human );

	static	void ShockTrooperGibs( entvars_t *pevVictim, int cGibs, int human );
	static	void PitDroneGibs( entvars_t *pevVictim, int cGibs, int human );

	static	void HoundeyeGibs( entvars_t *pevVictim, int cGibs, int human );

	static	void ZoBodyGibs( entvars_t *pevVictim );
	static	void ZoLegsGibs( entvars_t *pevVictim, int cGibs, int human );

	static	void HgruntHeadGibs( entvars_t *pevVictim );

	static	void IslaveGibs( entvars_t *pevVictim );
	static	void IslaveArmGibs( entvars_t *pevVictim, int cGibs, int human );

	static	void IslaveLegGibs( entvars_t *pevVictim, int cGibs, int human );
//	static	void ShockTrooperGibs( entvars_t *pevVictim );//SP: para shocktrooper
	static	void RobotHeadGib( entvars_t *pevVictim );
//	static	void GrenadeGibs( entvars_t *pevVictim, int cGibs, int human );

	static	void RobotArmGibs( entvars_t *pevVictim, int cGibs, int human );
	static	void RobotLegGibs( entvars_t *pevVictim, int cGibs, int human );
