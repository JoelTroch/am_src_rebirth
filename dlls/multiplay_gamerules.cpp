...
// override some values for multiplay.
	...
	// Hgrunt ak
	gSkillData.hGrunt_akHealth = 110;
	gSkillData.hGrunt_akDmgKick = 50;
	gSkillData.hGrunt_akShotgunPellets = 10;
	gSkillData.hGrunt_akGrenadeSpeed = 800;

//|SP|
	//knifes
	gSkillData.plrDmgKnife = 25; //25
	gSkillData.plrDmgKnifeStab = 65; //25
...
{
	// On récupère ici les cvars spécifiques à chaque client
...
//SP
	...
	{
		//|SP| Headshot, o sea DISPARO a la cabeza, si es otro daño que no cuente
