...
extern void			UTIL_ScreenShakeOne		( CBasePlayer *pPlayer, float amplitude, float frequency, float duration );
...
//SP: para barney para comprobar si esta viendose de frente
...
#define AMBIENT_SHOWMESSAGE				512 	//strings code
...
#define SF_BREAK_BYSEMTEX		1024// the breakeable can be damaged only by semtex

// func_pushable (it's also func_breakable, so don't collide with those flags)
#define SF_PUSH_BREAKABLE		128

//SYS: func_phys (new spawnflags)
#define SF_TAKEDAMAGE_NO		1
#define	SF_DONT_PICKUPFLOOR			2
#define SF_BREAK_PRESSURE		4
#define SF_MOVETYPE_PUSHSTEP	128
#define SF_SOLID_BSP			256
...
/*	if ( CVAR_GET_FLOAT("host_framerate") != 0 )
	EMIT_SOUND_DYN(entity, channel, sample, volume, attenuation, 0, 48 + RANDOM_FLOAT(0,3) );
	else
*/
//void EMIT_FMOD_SOUND( int entindex, Vector origin, const char *sample, int volume, int pitch);//fo0z
