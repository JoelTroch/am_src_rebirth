...
// Monster Health & Damage
	...
	float zombiepoisonHealth;
	float zombiepoisonMelee;
	...
	float hGrunt_akHealth;
	float hGrunt_akDmgKick;
	float hGrunt_akShotgunPellets;
	float hGrunt_akGrenadeSpeed;
