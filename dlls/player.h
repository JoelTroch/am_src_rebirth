...
public:
	...
	float m_flNextFogValueUpdateTime;
	float m_flNextNoiseValueUpdateTime;
	...
	BOOL m_fRicardoOn; //si esta activado o no.
	void RicardoToggle(BOOL activate);
