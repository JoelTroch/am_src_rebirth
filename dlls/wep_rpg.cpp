...
void CRpg::PrimaryAttack()
{
	...
	flags = 0;
		...
		m_flNextPrimaryAttack = UTIL_WeaponTimeBase() + 2.83;//1.5
...
//		while ((pEntidad = UTIL_FindEntityInSphere( pEntidad, pev->origin, 500 )) != NULL)
//		{
//			if (pEntidad->pev->deadflag != DEAD_DEAD)
//			UTIL_SetOrigin( m_pSpot->pev, pEntidad->Center() );
//		}
